...
type
  TDM = class(TDataModule)
    ...
    dsEspecialista: TDataSource;
    tbEspecialista: TFDTable;
    tbEspecialistaid: TFDAutoIncField;
    tbEspecialistaespecialista: TStringField;
    ...
    tbAgendamentoid_especialista: TIntegerField;
