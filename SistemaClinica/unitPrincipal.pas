...
type
  TformPrincipal = class(TForm)
    ...
    procedure Especialista1Click(Sender: TObject);
  private
...
uses unitCadPacientes, unitCadAgendamentos, unitCadEspecialista;
...
procedure TformPrincipal.Especialista1Click(Sender: TObject);
begin
  formCadEspecialista.ShowModal;
end;
